  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 w-full max-w-3xl mx-auto">
        <div className="flex flex-col md:flex-row rounded-2xl shadow-2xl overflow-hidden bg-white/70 backdrop-blur-sm animate-in slide-in-from-bottom-4 duration-1000 ease-in-out">
          {/* Left Panel */}
          <div className="md:w-1/2 w-full bg-blue-800 flex flex-col items-center justify-center p-8 text-white relative">
            <div className="flex flex-col items-center w-full">
              ...
              <button
                ...
                className="border border-white rounded-full px-8 py-2 font-semibold text-white hover:bg-white/10 transition-all duration-300 ease-in-out hover:scale-105 mb-2"
              >
                Create Account
              </button>
            </div>
          ...
          <div className="md:w-1/2 w-full bg-white/70 backdrop-blur-sm flex flex-col justify-center p-8">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              <div className="space-y-1">
                <Label htmlFor="role_select" className="text-sm font-semibold text-gray-800">Select Your Role</Label>
                <Select value={selectedRole} onValueChange={(value: any) => setSelectedRole(value)}>
                  <SelectTrigger className="border-2 border-gray-200 bg-white/80 focus:border-blue-500 transition-all duration-300 ease-in-out" id="role_select" name="role">
              ...
              <div className="space-y-1">
                ...
                <div className="relative">
                  ...
                  <Input
                    ...
                    className={`pl-10 pr-4 py-2 border-2 border-gray-200 bg-white/80 focus:border-blue-500 focus:ring-2 focus:ring-blue-500/20 transition-all duration-300 ease-in-out ${error ? 'border-red-500 focus:border-red-500' : ''}`}
                    disabled={isLoading}
                  />
                </div>
              </div>
              <div className="space-y-1">
                ...
                <div className="relative">
                  ...
                  <Input
                    ...
                    className={`pl-10 pr-10 py-2 border-2 border-gray-200 bg-white/80 focus:border-blue-500 focus:ring-2 focus:ring-blue-500/20 transition-all duration-300 ease-in-out ${error ? 'border-red-500 focus:border-red-500' : ''}`}
                    disabled={isLoading}
                  />
                  <Button
                    type="button"
                    variant="ghost"
                    size="sm"
                    className="absolute right-0 top-0 h-full px-3 hover:bg-transparent transition-all duration-300 ease-in-out border-0 shadow-none"
              ...
              {error && (
                <Alert variant="destructive" className="border-red-200 bg-red-50/80 animate-in slide-in-from-top-2 duration-500 ease-in-out">
              ...
              <Button 
                type="submit" 
                className={`w-full bg-blue-600 hover:bg-blue-700 shadow-xl text-white font-semibold py-2 text-base transition-all duration-300 ease-in-out`} 
                disabled={isLoading}
              >
                {isLoading ? (
                  <>
              ...
              <div className="flex flex-col items-center gap-2 pt-2">
                <Button
                  variant="link"
                  onClick={() => navigate('/register')}
                  className="text-gray-600 hover:text-blue-600 font-medium px-0 transition-all duration-300 ease-in-out hover:scale-105 border-0 shadow-none"
                >
